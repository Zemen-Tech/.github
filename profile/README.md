...
```mermaid
flowchart TD
    %% Color Palette: Blue (#0d233a), Gold (#D4AF37), White (#FFFFFF)
    classDef hub fill:#0d233a,stroke:#D4AF37,stroke-width:4px,color:#FFFFFF,font-size:16px,font-weight:bold;
    classDef defaultNode fill:#FFFFFF,stroke:#0d233a,stroke-width:2px,color:#0d233a,font-size:14px,font-weight:bold;
    classDef mlNode fill:#D4AF37,stroke:#0d233a,stroke-width:2px,color:#0d233a,font-size:14px,font-weight:bold;

    Center((Zemen Tech<br>Capabilities Hub)):::hub

    Web["🌐 Web & SaaS<br>(React & Django)"]:::defaultNode
    Mobile["📱 Mobile Apps<br>(Flutter)"]:::defaultNode
    ML["🧠 Machine Learning<br>(TF & PyTorch)"]:::mlNode
    Embedded["🔌 Embedded AI<br>(Edge Computing)"]:::defaultNode
    Data["📊 Data Engineering<br>(Cleaning & Acquisition)"]:::defaultNode

    %% Hub and Spoke Core Connections
    Center === Web
    Center === Mobile
    Center === ML
    Center === Embedded
    ...
    Data -.->|Architects Clean Data| ML
    ML -.->|Deploys Inteli-APIs| Web
    ML -.->|Powers Smart Features| Mobile
    ML -.->|Exports Edge Models| Embedded
```
